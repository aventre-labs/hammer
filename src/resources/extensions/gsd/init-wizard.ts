...
export function buildInitPreferencesBody(): string {
  return DEFAULT_PREFERENCES_BODY.replace(
    "Configure Hammer skill selection, IAM-aware execution defaults, and no-degradation preferences.",
    "Generated by `/hammer init`; edit directly or use `/hammer prefs project` to modify Hammer skill selection, IAM-aware execution defaults, and no-degradation preferences.",
  );
}
