const flag = (process.env.HAMMER_STARTUP_TIMING ?? process.env.GSD_STARTUP_TIMING ?? process.env.PI_TIMING ?? "").toLowerCase(); // GSD_STARTUP_TIMING is a legacy alias for compatibility — legacy-alias
